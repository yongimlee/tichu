  ...
  return (
    <details className="rules">
      ...
      <ul>
        ...
        <li>
          분배: <strong>8장</strong> → 라지 티츄(200점) 선언 → <strong>6장 추가</strong> → 스몰
          티츄(100점, 첫 카드 내기 전) → 세 명에게 1장씩 <strong>교환</strong>.
        </li>
        ...
        <li>티츄/라지티츄는 선언 후 그 판에 가장 먼저 아웃하면 보너스, 실패 시 그만큼 차감.</li>
      ...
      <ul>
        <li>
          <strong>참새(1)</strong>: 가장 낮은 단일. 보유자가 첫 리드. 낼 때 2~10, J~A를
